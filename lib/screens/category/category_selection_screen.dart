...
class _CategorySelectionScreenState extends State<CategorySelectionScreen> {
  ...
  /* final List<Widget> profiles = List.generate(
      10,
      (index) => ProfileCard(
            index: index,
            imageUrl:
                'https://numdea.com/wp-content/uploads/2020/03/definicion-servicios.jpg',
            description:
                'Descripción del perfil $index,publishing software like Aldus PageMaker including versions of Lorem Ipsum',
            categories: const ['casa', 'Aspirado', 'Lavado de ropa', 'baño'],
          )); */

  final SwipableStackController _controller = SwipableStackController();

  //print swipe prgress continuously
  void _onSwipeProgress(int index, double progress) {
        ...
        children: [
          ...
          SwipableStack(
            ...
            builder: (context, properties) {
              print(
                  'index: ${properties.index}, progress: ${properties.swipeProgress}');
              return Align(
